...
我在中南林业科技大学（CSUFT），学校里人手一张校园卡，食堂、图书馆、寝室门禁全用它。有段时间我对 NFC 的原理特别好奇——一张塑料卡片凭什么能在刷卡机上一碰就完成身份识别？正好嘉立创每个月给两次免费打板额度，于是决定自己画一张 CSUFT 主题的 PCB 校园卡，把"卡片内部到底长什么样"这个问题彻底搞明白。
...
焊完第一件事是用手机 NFC 工具 App 扫一下——读写正常，能写入文本、URL、联系方式等 NDEF 格式数据。用林科大的寝室门禁读卡器测试也能正常识别，和普通校园卡一样灵敏。
